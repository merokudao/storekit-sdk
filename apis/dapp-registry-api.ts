...
import { PreSignedUrlsResponse } from '../models';
/**
...
export const DAppRegistryApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        uploadFileLogo: async (dappId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'dappId' is not null or undefined
            if (dappId === null || dappId === undefined) {
                throw new RequiredError('dappId','Required parameter dappId was null or undefined when calling uploadFileLogo.');
            }
            const localVarPath = `/dapp/{dappId}/upload/logo`
                .replace(`{${"dappId"}}`, encodeURIComponent(String(dappId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
        ...
        /**
         * Generate pre signed URL for screenshots
         * @summary Generate PreSigned URL screenshots
         * @param {string} dappId Dapp Id where upload will happen
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        uploadFileSS: async (dappId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'dappId' is not null or undefined
            if (dappId === null || dappId === undefined) {
                throw new RequiredError('dappId','Required parameter dappId was null or undefined when calling uploadFileSS.');
            }
            const localVarPath = `/dapp/{dappId}/upload/screenshots`
                .replace(`{${"dappId"}}`, encodeURIComponent(String(dappId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
        ...
        /**
         * Generate pre signed URL for banner
         * @summary Generate PreSigned URL Banner
         * @param {string} dappId Dapp Id where upload will happen
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        uploadFilebanner: async (dappId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'dappId' is not null or undefined
            if (dappId === null || dappId === undefined) {
                throw new RequiredError('dappId','Required parameter dappId was null or undefined when calling uploadFilebanner.');
            }
            const localVarPath = `/dapp/{dappId}/upload/banner`
                .replace(`{${"dappId"}}`, encodeURIComponent(String(dappId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
        ...
        /**
         * Generate pre signed URL for build
         * @summary Generate PreSigned URL Build
         * @param {string} dappId Dapp Id where upload will happen
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        uploadFilebuild: async (dappId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'dappId' is not null or undefined
            if (dappId === null || dappId === undefined) {
                throw new RequiredError('dappId','Required parameter dappId was null or undefined when calling uploadFilebuild.');
            }
            const localVarPath = `/dapp/{dappId}/upload/build`
                .replace(`{${"dappId"}}`, encodeURIComponent(String(dappId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const DAppRegistryApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async uploadFileLogo(dappId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PreSignedUrlResponse>>> {
            const localVarAxiosArgs = await DAppRegistryApiAxiosParamCreator(configuration).uploadFileLogo(dappId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async uploadFileSS(dappId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PreSignedUrlsResponse>>> {
            const localVarAxiosArgs = await DAppRegistryApiAxiosParamCreator(configuration).uploadFileSS(dappId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async uploadFilebanner(dappId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PreSignedUrlResponse>>> {
            const localVarAxiosArgs = await DAppRegistryApiAxiosParamCreator(configuration).uploadFilebanner(dappId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async uploadFilebuild(dappId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PreSignedUrlResponse>>> {
            const localVarAxiosArgs = await DAppRegistryApiAxiosParamCreator(configuration).uploadFilebuild(dappId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const DAppRegistryApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async uploadFileLogo(dappId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<PreSignedUrlResponse>> {
            return DAppRegistryApiFp(configuration).uploadFileLogo(dappId, options).then((request) => request(axios, basePath));
        },
        /**
         * Generate pre signed URL for screenshots
         * @summary Generate PreSigned URL screenshots
         ...
         * @throws {RequiredError}
         */
        async uploadFileSS(dappId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<PreSignedUrlsResponse>> {
            return DAppRegistryApiFp(configuration).uploadFileSS(dappId, options).then((request) => request(axios, basePath));
        },
        /**
         * Generate pre signed URL for banner
         * @summary Generate PreSigned URL Banner
         ...
         * @throws {RequiredError}
         */
        async uploadFilebanner(dappId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<PreSignedUrlResponse>> {
            return DAppRegistryApiFp(configuration).uploadFilebanner(dappId, options).then((request) => request(axios, basePath));
        },
        /**
         * Generate pre signed URL for build
         * @summary Generate PreSigned URL Build
         ...
         * @throws {RequiredError}
         */
        async uploadFilebuild(dappId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<PreSignedUrlResponse>> {
            return DAppRegistryApiFp(configuration).uploadFilebuild(dappId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class DAppRegistryApi extends BaseAPI {
     ...
     * @memberof DAppRegistryApi
     */
    public async uploadFileLogo(dappId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<PreSignedUrlResponse>> {
        return DAppRegistryApiFp(this.configuration).uploadFileLogo(dappId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Generate pre signed URL for screenshots
     * @summary Generate PreSigned URL screenshots
     ...
     * @memberof DAppRegistryApi
     */
    public async uploadFileSS(dappId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<PreSignedUrlsResponse>> {
        return DAppRegistryApiFp(this.configuration).uploadFileSS(dappId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Generate pre signed URL for banner
     * @summary Generate PreSigned URL Banner
     ...
     * @memberof DAppRegistryApi
     */
    public async uploadFilebanner(dappId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<PreSignedUrlResponse>> {
        return DAppRegistryApiFp(this.configuration).uploadFilebanner(dappId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Generate pre signed URL for build
     * @summary Generate PreSigned URL Build
     ...
     * @memberof DAppRegistryApi
     */
    public async uploadFilebuild(dappId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<PreSignedUrlResponse>> {
        return DAppRegistryApiFp(this.configuration).uploadFilebuild(dappId, options).then((request) => request(this.axios, this.basePath));
    }
}
