 ...
 * 
 * @export
 * @interface DappReferredBy
 */
export interface DappReferredBy {
    /**
     * The name of the vendor who have shared Dapp details
     * @type {string}
     * @memberof DappReferredBy
     */
    name?: string;
    /**
     * The domain of the vendor who have shared Dapp details
     * @type {string}
     * @memberof DappReferredBy
     */
    url?: string;
