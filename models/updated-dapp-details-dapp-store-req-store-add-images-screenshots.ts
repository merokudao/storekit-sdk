 ...
 * 
 * @export
 * @interface UpdatedDappDetailsDappStoreReqStoreAddImagesScreenshots
 */
export interface UpdatedDappDetailsDappStoreReqStoreAddImagesScreenshots {
    /**
     * 
     * @type {number}
     * @memberof UpdatedDappDetailsDappStoreReqStoreAddImagesScreenshots
     */
    index?: number;
    /**
     * ipfs link of image
