 ...
 */
/**
 * The credentials of developer.
 * @export
 * @interface DappDeveloperCredentials
 */
export interface DappDeveloperCredentials {
    /**
     * Id of developer.
     * @type {string}
     * @memberof DappDeveloperCredentials
     */
    id?: string;
    /**
     * Name of developer platform
     * @type {string}
     * @memberof DappDeveloperCredentials
     */
    type?: string;
