 ...
 */
import { UpdatedDappDetailsDappStoreReqStoreAddGeoRestrictions } from './updated-dapp-details-dapp-store-req-store-add-geo-restrictions';
import { UpdatedDappDetailsDappStoreReqStoreAddImages } from './updated-dapp-details-dapp-store-req-store-add-images';
/**
 * 
 * @export
 * @interface UpdatedDappDetailsDappStoreReqStoreAdd
 */
export interface UpdatedDappDetailsDappStoreReqStoreAdd {
    /**
     * 
     * @type {string}
     * @memberof UpdatedDappDetailsDappStoreReqStoreAdd
     */
    minAge?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {UpdatedDappDetailsDappStoreReqStoreAddGeoRestrictions}
     * @memberof UpdatedDappDetailsDappStoreReqStoreAdd
     */
    geoRestrictions?: UpdatedDappDetailsDappStoreReqStoreAddGeoRestrictions;
    /**
     * 
     * @type {UpdatedDappDetailsDappStoreReqStoreAddImages}
     * @memberof UpdatedDappDetailsDappStoreReqStoreAdd
     */
    images?: UpdatedDappDetailsDappStoreReqStoreAddImages;
}
