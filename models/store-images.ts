...
export interface StoreImages {
    /**
     * A URL to the logo of the store. Should be square and 512x512 in PNG format
     * @type {Blob}
     * @memberof StoreImages
     */
    logo?: Blob;
    /**
     * A URL to the banner of the store. Should be 1920x1080 and in PNG format
     * @type {Blob}
     * @memberof StoreImages
     */
    banner?: Blob;
    /**
     * A list of URLs to the screenshots of the store. Should be 1284 x 2778 and in PNG format
     * @type {Array<Blob>}
     * @memberof StoreImages
     */
