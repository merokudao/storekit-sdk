 ...
 * 
 * @export
 * @interface UpdatedDappDetailsDappStoreReqStoreAddGeoRestrictions
 */
export interface UpdatedDappDetailsDappStoreReqStoreAddGeoRestrictions {
    /**
     * 
     * @type {Array<string>}
     * @memberof UpdatedDappDetailsDappStoreReqStoreAddGeoRestrictions
     */
