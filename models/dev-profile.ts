 ...
 */
import { DappDeveloperCredentials } from './dapp-developer-credentials';
import { DevProfileImages } from './dev-profile-images';
/**
 * 
 * @export
...
export interface DevProfile {
    ...
    legalName?: string;
    /**
     * The website url of a developer
     * @type {Blob}
     * @memberof DevProfile
     */
    website?: Blob;
    /**
     * detail description of the developer.
     * @type {string}
     * @memberof DevProfile
     */
    descritpion?: string;
    /**
     * The owner address of the developer nft
     * @type {string}
     * @memberof DevProfile
     */
    ownerAddress?: string;
    /**
     * 
     * @type {DevProfileImages}
     * @memberof DevProfile
     */
    images?: DevProfileImages;
    /**
     * 
     * @type {DappDeveloperCredentials}
     * @memberof DevProfile
     */
    credentials?: DappDeveloperCredentials;
}
