 ...
 * 
 * @export
 * @interface DomainverificationGetVerificationIdBody
 */
export interface DomainverificationGetVerificationIdBody {
    /**
     * 
     * @type {string}
     * @memberof DomainverificationGetVerificationIdBody
     */
    githubId: string;
    /**
     * 
