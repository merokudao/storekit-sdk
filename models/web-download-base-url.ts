 ...
 * 
 * @export
 * @interface WebDownloadBaseUrl
 */
export interface WebDownloadBaseUrl {
    /**
     * The url to download the dapp.
     * @type {Blob}
     * @memberof WebDownloadBaseUrl
     */
    url: Blob;
    /**
     ...
     * @memberof WebDownloadBaseUrl
     */
    platform?: WebDownloadBaseUrlPlatformEnum;
    /**
     * The latest Version of PWA.
     * @type {string}
     * @memberof WebDownloadBaseUrl
     */
    version: string;
...
/**
    ...
    * @enum {string}
    */
export enum WebDownloadBaseUrlPlatformEnum {
    Web = 'web'
}
