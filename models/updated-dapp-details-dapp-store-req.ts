 ...
 */
import { UpdatedDappDetailsDappStoreReqStore } from './updated-dapp-details-dapp-store-req-store';
/**
 * 
 * @export
 * @interface UpdatedDappDetailsDappStoreReq
 */
export interface UpdatedDappDetailsDappStoreReq {
    /**
     * The name of the developer (from GitHub)
     * @type {string}
     * @memberof UpdatedDappDetailsDappStoreReq
     */
    name: string;
    /**
    ...
    /**
     * 
     * @type {UpdatedDappDetailsDappStoreReqStore}
     * @memberof UpdatedDappDetailsDappStoreReq
     */
    store: UpdatedDappDetailsDappStoreReqStore;
}
